...
这是一个只在学习者明确确认成年并自愿加入后启用的可选模式，可有 1–3 位原创成年导师。每位导师有 0–3 颗心；每个 checkpoint 的学习工作完成后，最多出现一次可跳过的关系选择，一次只给一位导师加一心且不会让其他导师扣心。达到 2 心后，结课可选择友情或轻恋爱 epilogue，也可以拒绝并保留群像结局。

好感度与答题正确、学习时间、连续签到、服从导师、付费或披露隐私完全分离。错误、跳过、暂停、不同意导师或请求直接解释都不会扣心，也不能导致导师撤回温暖或降低教学质量。该模式不包含露骨性内容、嫉妒争宠、排他要求或内疚操控。
